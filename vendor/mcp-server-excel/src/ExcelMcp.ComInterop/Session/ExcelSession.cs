...
public static class ExcelSession
{
    ...
    public static IExcelBatch BeginBatch(
        ...
        => BeginBatch(show, operationTimeout, allowMacros: false, filePaths);

    /// <summary>
    /// Opens workbooks in one Excel process.
    /// </summary>
    /// <param name="show">Whether to show Excel while opening.</param>
    /// <param name="operationTimeout">Startup and per-operation timeout.</param>
    /// <param name="allowMacros">When true, macro-enabled workbooks may run Workbook_Open. Verification and ordinary edits pass false.</param>
    /// <param name="filePaths">Workbook paths. The first path is primary.</param>
    public static IExcelBatch BeginBatch(
        bool show,
        TimeSpan? operationTimeout,
        bool allowMacros,
        params string[] filePaths)
    {
        ...
        return new ExcelBatch(fullPaths, logger: null, show: show, operationTimeout: operationTimeout, allowMacros: allowMacros);
    }
