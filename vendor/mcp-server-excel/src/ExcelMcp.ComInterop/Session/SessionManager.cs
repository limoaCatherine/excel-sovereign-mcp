...
public sealed class SessionManager : IDisposable
{
    ...
    /// </remarks>
    public string CreateSession(string filePath, bool show = false, TimeSpan? operationTimeout = null, SessionOrigin origin = SessionOrigin.Unknown, bool allowMacros = false)
    {
        ...
        try
        {
            ...
            batch = _sessionCreationPipeline.Execute(() => ExcelSession.BeginBatch(show, operationTimeout, allowMacros, filePath));
